...
prepend = '/work/ws-tmp/sa058646-segment2/stereo-transformer/data/SCENE_FLOW/frame_finalpass'
...
f = open('/work/ws-tmp/sa058646-segment2/stereo-transformer/data/SCENE_FLOW/all_unused_files.txt', 'r')
for img in f:
